...
<section class="container">
  ...
  <div class="content-wrap"> 	
    <div class="content">
        <form:form  modelAttribute="article" action="saveArticle" enctype="multipart/form-data">
        	<h1>文章编辑</h1>
  			标题：<form:input class="form-control" path="title"/><br>
  			文章类型：<form:select class="form-control" path="categoryid" items="${cList}"  itemLabel="name" itemValue="id"></form:select><br>
  			标签：<form:input class="form-control" path="label"/><br>
            <form:textarea class="form-control" path="content" rows="10" cols="80"/>         
