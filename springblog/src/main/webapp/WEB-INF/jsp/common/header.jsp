  ...
  <nav class="navbar navbar-default" id="navbar">
    <div class="container">
      <div class="header-topbar hidden-xs link-border">
        ...
        <a data-toggle="modal" data-target="${loginedUser == null ? '#loginModal' : ''}" class="login" rel="nofollow">${loginedUser == null ? 'Hi,请登录' : '欢迎：'.concat(loginedUser.cnName)}</a>&nbsp;&nbsp;<a href="javascript:;" class="register" rel="nofollow">我要注册</a>&nbsp;&nbsp;<a href="" rel="nofollow">找回密码</a>&nbsp;&nbsp;<a href="toedit" rel="nofollow">发布文章</a> </div>
